...
topojson --id-property postal -s 0.00001 -o political-usa.topo.json political-usa.json
...
topojson --id-property adm0_a3 -s 0.00001 -o political-north-america.topo.json political-north-america.json
